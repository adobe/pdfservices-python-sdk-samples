...
#
class CreatePdfFromPPTX:
    def __init__(self):
        try:
            file = open('src/resources/createPDFInput.pptx', 'rb')
    ...
    def create_output_file_path() -> str:
        ...
        os.makedirs("output/CreatePDFFromPPTX", exist_ok=True)
        return f"output/CreatePDFFromPPTX/create{time_stamp}.pdf"
