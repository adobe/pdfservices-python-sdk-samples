...
class PDFWatermark:
    def __init__(self):
        try:
            ...
            watermark_asset = pdf_services.upload(input_stream=watermark_file_input_stream,
            ...
            pdf_watermark_params = PDFWatermarkParams(page_ranges=page_ranges,
                                                      watermark_appearance=watermark_appearance)
    ...
    def create_output_file_path(self) -> str:
        ...
        os.makedirs("output/PDFWatermarkWithOptions", exist_ok=True)
        return f"output/PDFWatermarkWithOptions/pdfwatermark{time_stamp}.pdf"
