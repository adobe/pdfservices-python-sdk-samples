...
class MergeDocumentToDOCXWithFragments:
    def __init__(self):
        try:
            file = open('src/resources/documentMergeFragmentsTemplate.docx', 'rb')
    ...
    def create_output_file_path() -> str:
        ...
        os.makedirs("output/MergeDocumentToDOCXWithFragments", exist_ok=True)
        return f"output/MergeDocumentToDOCXWithFragments/merge{time_stamp}.docx"
