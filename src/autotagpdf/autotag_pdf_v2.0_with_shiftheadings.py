...
try:
    ...
    base_output_path = base_path + "/output/AutotagPDFWithV20AndShiftHeadings/"
    ...
    autotag_pdf_options: AutotagPDFOptions = AutotagPDFOptions.builder().with_pdf_version(PdfVersion.v20).with_shift_headings().build()
