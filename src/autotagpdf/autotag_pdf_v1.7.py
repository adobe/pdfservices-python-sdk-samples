...
try:
    ...
    base_output_path = base_path + "/output/AutotagPDFWithV17/"
    ...
    autotag_pdf_options: AutotagPDFOptions = AutotagPDFOptions.builder().with_pdf_version(PdfVersion.v17).build()
