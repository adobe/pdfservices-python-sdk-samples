...
from adobe.pdfservices.operation.internal.api.dto.request.autotagpdf.autotag_pdf_output_files import AutotagPDFOutputFiles
...
try:
    ...
    base_output_path = base_path + "/output/AutotagPDFWithV17AndShiftHeadings/"
    ...
    autotag_pdf_options: AutotagPDFOptions = AutotagPDFOptions.builder().with_pdf_version(PdfVersion.v17).with_shift_headings().build()
