...
class ExtractTextTableInfoWithCharBoundsFromPDF:
    ...
    def create_output_file_path() -> str:
        ...
        os.makedirs("output/ExtractTextTableInfoWithCharBoundsFromPDF", exist_ok=True)
        return f"output/ExtractTextTableInfoWithCharBoundsFromPDF/extract{time_stamp}.zip"
