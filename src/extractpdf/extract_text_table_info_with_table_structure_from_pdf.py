...
class ExtractTextTableInfoWithTableStructureFromPDF:
    ...
    def create_output_file_path() -> str:
        ...
        os.makedirs("output/ExtractTextTableInfoWithTableStructureFromPDF", exist_ok=True)
        return f"output/ExtractTextTableInfoWithTableStructureFromPDF/extract{time_stamp}.zip"
